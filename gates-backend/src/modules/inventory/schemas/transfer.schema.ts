...
export const createTransferSchema = z
  .object({
    ...
    fromCostCenterId: z.preprocess(
      emptyToUndef,
      z.string().uuid('From cost center ID must be a valid UUID').optional().nullable()
    ),
    toCostCenterId: z.preprocess(
      emptyToUndef,
      z.string().uuid('To cost center ID must be a valid UUID').optional().nullable()
    ),
