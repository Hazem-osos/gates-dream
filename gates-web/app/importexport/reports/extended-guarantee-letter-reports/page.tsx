...
export default function ExtendedGuaranteeLetterReportsPage() {
...
useBackendReachability();
  ...
  const handlePreview = () => {
    ...
    router.push(`/importexport/reports/extended-guarantee-letter-reports/preview?${params.toString()}`);
  };
  ...
  return (
    <CatalogReportFilterShell
      ...
      subtitle="تمديد خطابات الضمان ضمن الفترة المحددة."
    >
