...
export default function UnitSalePrivate() {
  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-6">
          <div className="rounded-2xl border border-[#D6EAF3] bg-white p-6 shadow-sm">
            ...
            <div className="flex flex-col gap-4">
              <label className="flex items-center gap-3 rounded-lg p-2 text-[#094C6B]">
              ...
              <div className="flex items-center gap-3 rounded-lg bg-[#F6FBFD] p-2">
                ...
                <input type="number" className="w-24 rounded-lg border border-[#B6D6EA] bg-white px-3 py-2 text-right text-sm" placeholder="إدخل العدد" />
              </div>
              <label className="flex items-center gap-3 rounded-lg p-2 text-[#094C6B]">
      ...
      <MasterCardShell
        title="تعريف وحدة للبيع خاصة"
        breadcrumbs={crumbs}
        favoriteHref="/real-estate-investment/create/unit-sale-private"
        onSave={() => toast.success('تم الحفظ')}
        extraActions={
          <div className="flex flex-wrap gap-2">
            <Button type="button" variant="secondary" size="sm" onClick={() => setDrawerOpen(true)}>تفاصيل الوحدة</Button>
