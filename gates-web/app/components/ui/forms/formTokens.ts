...
export const denseThClass = 'px-3 text-right whitespace-nowrap border-e border-white/20 last:border-e-0';

export const denseTdClass = 'px-3 text-right text-slate-700 border-e border-[#E8F1F6] last:border-e-0';

export const denseTrClass =
  'h-10 hover:bg-[#E8F4FA] transition-colors border-b border-[#E8F1F6]';
