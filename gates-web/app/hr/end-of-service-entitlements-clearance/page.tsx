...
import {
  ...
  type EndOfServiceEntitlementsClearanceFormInput,
...
export default function EndOfServiceEntitlementsClearancePage() {
  ...
  const {
    ...
    setValue,
    formState: { errors },
  } = useForm<EndOfServiceEntitlementsClearanceFormInput>({
    resolver: zodResolver(endOfServiceEntitlementsClearanceFormSchema) as Resolver<EndOfServiceEntitlementsClearanceFormInput>,
    defaultValues: defaults,
    mode: 'onTouched',
  });

  const onSave: SubmitHandler<EndOfServiceEntitlementsClearanceFormInput> = (values) => {
    console.info('[end-of-service-entitlements-clearance]', values);
  };
            ...
            <div className="mb-8 space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <div className="space-y-4 lg:order-1">
                  ...
                  <div>
                    <label className="block text-sm text-[#094C6B] mb-2">قيمة أيام الاجازات</label>
                    <input type="text" className={inputCls} {...register('vacationDaysValue')} />
                  </div>
                ...
                <div className="space-y-4 lg:order-2">
                  <div>
                    <label className="block text-sm text-[#094C6B] mb-2">أيام العمل</label>
                    <input type="text" className={inputCls} placeholder="إدخل أيام العمل" {...register('workDays')} />
                  </div>
                  <div>
                    <label className="block text-sm text-[#094C6B] mb-2">أيام الغياب</label>
                    <input type="text" className={inputCls} placeholder="إدخل أيام الغياب" {...register('absenceDays')} />
                  </div>
                  <div>
                    <label className="block text-sm text-[#094C6B] mb-2">سنوات العمل</label>
                    <input type="text" className={inputCls} {...register('yearsOfWork')} />
                  </div>
                  <div>
                    <label className="block text-sm text-[#094C6B] mb-2">صافي أيام العمل</label>
                    <input type="text" className={inputCls} {...register('netWorkDays')} />
                  </div>
                  <div>
                    <label className="block text-sm text-[#094C6B] mb-2">أيام الأجازات</label>
                    <input type="text" className={inputCls} {...register('vacationDays')} />
                  </div>
                  <div>
                    <label className="block text-sm text-[#094C6B] mb-2">الأيام المستحقة</label>
                    <input type="text" className={inputCls} {...register('dueDays')} />
                  </div>
                  <div>
                    <label className="block text-sm text-[#094C6B] mb-2">قيمة الأيام المستحقة</label>
                    <input type="text" className={inputCls} {...register('dueDaysValue')} />
                  </div>
                </div>
              </div>
