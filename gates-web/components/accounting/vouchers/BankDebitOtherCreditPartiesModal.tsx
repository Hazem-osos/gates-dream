...
import { BankDebitLinesTable } from './BankDebitLinesTable';
...
export function BankDebitOtherCreditPartiesModal({
  open,
  lines,
  currencies,
  baseCurrency = 'EGP',
    ...
    <div className="fixed inset-0 z-[10050] flex items-center justify-center bg-slate-900/40 p-4" dir="rtl">
      ...
      <div className="relative flex max-h-[90vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-[#E6F0F7] bg-white shadow-2xl">
        <div className="border-b border-[#E6F0F7] px-5 py-4">
          <h2 className="text-lg font-bold text-[#0A3D5E]">إضافة أطراف دائنة أخرى (استقطاعات / ضرائب مخصومة / خصومات)</h2>
          <p className="mt-1 text-xs text-slate-500">
            البيانات المدخلة هنا ستُدرج في الجانب الدائن من القيد لتقليل صافي المبلغ المخصوم من رصيد البنك.
          </p>
        </div>
        <div className="flex-1 overflow-auto p-4">
          <BankDebitLinesTable
            gridId="bank-debit-credit-parties"
            lines={draft}
            onChange={setDraft}
