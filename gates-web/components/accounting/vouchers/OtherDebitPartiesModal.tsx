...
export function OtherDebitPartiesModal({
  open,
  lines,
  currencies,
  baseCurrency = 'EGP',
      ...
      <div className="relative flex max-h-[90vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-[#E6F0F7] bg-white shadow-2xl">
        <div className="border-b border-[#E6F0F7] px-5 py-4">
          <h2 className="text-lg font-bold text-[#0A3D5E]">
            إضافة أطراف مدينة أخرى (استقطاعات / خصم مسموح به / ضرائب مخصومة منا)
          </h2>
          <p className="mt-1 text-xs text-slate-500">
            البيانات المدخلة هنا ستُدرج في الجانب المدين من القيد المحاسبي لتقليل صافي المقبوض فعلياً بالخزنة مقابل
            سداد كامل المستحق على العميل.
          </p>
        </div>
        <div className="flex-1 overflow-auto p-4">
          <ReceiptLinesTable
            gridId="debit-parties"
            lines={draft}
            onChange={setDraft}
