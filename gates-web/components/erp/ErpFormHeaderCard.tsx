  ...
  return (
    <Card className="border-slate-200 shadow-sm rounded-xl overflow-hidden mt-2">
      <CardContent className="space-y-3 p-3 sm:p-4">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">{row1}</div>
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">{row2}</div>
        {extras ? (
          <>
