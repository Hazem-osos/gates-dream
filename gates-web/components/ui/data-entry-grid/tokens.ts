...
export const dataEntryGridHeadCellClass =
  'py-2.5 px-3 whitespace-nowrap text-right border-e border-white/20 last:border-e-0';

export const dataEntryGridBodyCellClass =
